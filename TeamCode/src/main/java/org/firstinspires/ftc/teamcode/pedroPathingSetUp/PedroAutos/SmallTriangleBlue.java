...
public class SmallTriangleBlue extends OpMode {
    ...
    private final Pose startPose = new Pose(42.343, 8.401, Math.toRadians(90));//DONT CHANGE
    private final Pose shootPose = new Pose(59.814, 19.606, Math.toRadians(113));
    private final Pose endPose = new Pose(38.308, 28.405, Math.toRadians(90));
